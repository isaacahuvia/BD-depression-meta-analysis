...
df.fu <- df %>%
        ...
        pivot_longer(cols = time.fu1:varG.fu2,
...
```{r}
model.post.IO <- robu(formula = g.post_alt ~ 1, 
                 data = df, 
                 studynum = studyID, 
