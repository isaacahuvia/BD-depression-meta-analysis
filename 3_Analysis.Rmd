...
Meta-analysis is conducted using robuse variance estimation (RVE) methods with `robumeta` <https://cran.r-project.org/web/packages/robumeta/vignettes/robumetaVignette.pdf>. See also Hedges, L. V., Tipton, E., & Johnson, M. C. (2010). Robust variance estimation in meta‐regression with dependent effect size estimates. Research synthesis methods, 1(1), 39-65.
